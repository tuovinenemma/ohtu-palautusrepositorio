...
class TestOstoskori(unittest.TestCase):
    ...
    def test_saman_kahden_tuotteen_lisaamisen_jalkeen_ostoskorin_hinta_sama_kuin_tuotteiden(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
    ...
    def test_kahden_saman_tuotteen_lisaamisen_jalkeen_korissa_kaksi_ostosoliota(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
        ostokset = self.kori.ostokset()
        self.assertEqual(len(ostokset), 1)
    ...
    def test_jos_korissa_kaksi_samaa_tuotetta_ja_toinen_poistetaan_lukumaara_on_yksi(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.lisaa_tuote(self.maito)
    ...
    def test_jos_korissa_yksi_tuotete_ja_se_poistetaan_kori_tyhja(self):
        self.kori.lisaa_tuote(self.maito)
        self.kori.poista_tuote(self.maito)
        self.assertEqual(self.kori.tavaroita_korissa(), 0)
